...
const newProducts = [
  {
    ...
    description: 'Nouvelle variété aux arômes fruités et sucrés',
  },
  {
    id: 'new-2',
    name: 'Huile CBD 30%',
    ...
    description: 'Notre nouvelle huile ultra-concentrée',
  },
  {
    id: 'new-3',
    name: 'Purple Haze',
    ...
    description: 'Variété légendaire enfin disponible',
  },
  {
    id: 'new-4',
  ...
  },
  {
    ...
    description: 'Notes de fraise et de fruits rouges',
  },
  {
    id: 'new-6',
...
const categories = ['Tous', 'Fleurs CBD', 'Huiles CBD', 'Cosmétiques CBD', 'Infusions CBD']
